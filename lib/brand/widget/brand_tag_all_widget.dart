...
class BrandTagsAllWidget extends StatefulWidget {
  final Overview? overview;

  const BrandTagsAllWidget({Key? key, this.overview}) : super(key: key);

  @override
  _BrandTagsAllWidgetState createState() => _BrandTagsAllWidgetState();
}

class _BrandTagsAllWidgetState extends State<BrandTagsAllWidget> {
  @override
                        ...
                        child: Padding(
                          ...
                          child: Wrap(
                            ...
                            children: _industryWidget(
                                widget.overview!.tags ?? []), //要显示的子控件集合
                          ),
                        ))))
          ],
        ));
