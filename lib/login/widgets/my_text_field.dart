...
class MyTextField extends StatefulWidget {
  ...
  final PublishSubject<bool>? smsSubject;
...
class _MyTextFieldState extends State<MyTextField> {
  ...
  void initState() {
    ...
    if (widget.smsSubject != null) {
      widget.smsSubject!.listen((value) {
        _getVCode(isValue: value);
      });
    }
  }
  ...
  Future _getVCode({bool? isValue}) async {
    bool isSuccess = false;
    if (isValue != null) {
      isSuccess = isValue;
    } else {
      isSuccess = await widget.getVCode!();
    }
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.getVCode != null) {
      getVCodeButton = MyButton(
        ...
        text: _clickable ? 'Send' : '（$_currentSecond s）',
