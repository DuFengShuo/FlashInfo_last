...
class TextStyles {
  ...
  static TextStyle textBold10 =
      TextStyle(fontSize: Dimens.font_sp10, fontWeight: FontWeight.w600);
  static TextStyle textBold11 =
      TextStyle(fontSize: Dimens.font_sp11, fontWeight: FontWeight.w600);
  static TextStyle textBold12 =
      TextStyle(fontSize: Dimens.font_sp12, fontWeight: FontWeight.bold);
  static TextStyle textBold13 =
      TextStyle(fontSize: Dimens.font_sp13, fontWeight: FontWeight.w600);
  static TextStyle textBold14 =
      TextStyle(fontSize: Dimens.font_sp14, fontWeight: FontWeight.w600);
  static TextStyle textBold15 =
      TextStyle(fontSize: Dimens.font_sp15, fontWeight: FontWeight.w600);
  static TextStyle textBold16 =
      TextStyle(fontSize: Dimens.font_sp16, fontWeight: FontWeight.w600);
  static TextStyle textBold17 =
      TextStyle(fontSize: Dimens.font_sp17, fontWeight: FontWeight.w600);
  static TextStyle textBold18 =
      TextStyle(fontSize: Dimens.font_sp18, fontWeight: FontWeight.w600);
  static TextStyle textBold20 =
      TextStyle(fontSize: Dimens.font_sp20, fontWeight: FontWeight.w600);
  static TextStyle textBold24 =
      TextStyle(fontSize: Dimens.font_sp24, fontWeight: FontWeight.w600);
  static TextStyle textBold26 =
      TextStyle(fontSize: Dimens.font_sp26, fontWeight: FontWeight.w600);
  static TextStyle textBold28 =
      TextStyle(fontSize: Dimens.font_sp28, fontWeight: FontWeight.w600);
